...
then
	...
	echo "» Instalez Romanian - Programmers.icns"
	sudo curl --silent "https://raw.github.com/tvararu/romanian-programmers-mac/master/Romanian%20-%20Programmers.icns" --output "/Library/Keyboard Layouts/Romanian - Programmers.icns"
	echo "» Instalez Romanian - Programmers.keylayout"
	sudo curl --silent "https://raw.github.com/tvararu/romanian-programmers-mac/master/Romanian%20-%20Programmers.keylayout" --output "/Library/Keyboard Layouts/Romanian - Programmers.keylayout"
fi
